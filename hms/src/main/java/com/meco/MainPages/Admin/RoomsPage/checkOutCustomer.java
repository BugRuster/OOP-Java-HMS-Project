...
public class checkOutCustomer extends javax.swing.JFrame {
    ...
    private void checkOutBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkOutBtnActionPerformed
        ...
        if (!roomNoString.equals("0")) {
            ...
            roomStatus = DB.getRoomStatus(Integer.parseInt(roomNoString));
        }
        if (!validRoomNumber || !roomStatus.equals("1")) { // roomStatus = 1 means the room is booked
            JOptionPane.showMessageDialog(null, "Please enter a valid room number!", "Invalid Input", 2);
        } else {
            DB.deleteUser("room_no", roomNoString); // delete user from the roomData table
        ...
        String checkOut = sdf.format(checkOutDate.getDate());
